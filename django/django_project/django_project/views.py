...
height: 300px;
    ...
    border-top: 1px solid var(--neutral-tertiary-alt-color,#c8c8c8);
    bottom: 0;
    /* position: absolute; */
    width: 10%;
    z-index: 200;
...
<body>
  <div>
    <h1>Info Pollution QC</h1>

<iframe title="Test" width="1200" height="3500" src="https://app.powerbi.com/view?r=eyJrIjoiY2Y2Nzc1MzItNWNmMi00NzBkLWI2ZmItYzNiMWRlYjJiZTQ2IiwidCI6IjU4N2FiZDAxLWViODgtNDFjMC1iMjBlLTYxZjFkYzViOTM2NCJ9&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>
...
<iframe title="Test - Page 1" width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiY2Y2Nzc1MzItNWNmMi00NzBkLWI2ZmItYzNiMWRlYjJiZTQ2IiwidCI6IjU4N2FiZDAxLWViODgtNDFjMC1iMjBlLTYxZjFkYzViOTM2NCJ9" frameborder="0" allowFullScreen="true"></iframe>
-->
  </div>
</body>
</html>
